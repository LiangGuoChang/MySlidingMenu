...
public class TTSController implements AMapNaviListener {
    ...
    public void init() {
        ...
        /*String iflyAppid="输入您讯飞的appid";
        String text = mContext.getString(Integer.parseInt(iflyAppid));
        ...
        //添加appid
        SpeechUtility.createUtility(mContext,SpeechConstant.APPID+"=58be58cc");
        // 初始化合成对象.
