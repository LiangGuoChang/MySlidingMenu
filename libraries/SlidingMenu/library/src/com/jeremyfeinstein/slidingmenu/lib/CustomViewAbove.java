...
public class CustomViewAbove extends ViewGroup {
	...
	void initCustomViewAbove() {
		...
		setInternalPageChangeListener(new SimpleOnPageChangeListener() {  // TODO: 2016/12/22 据说可以去掉
			public void onPageSelected(int position) {
				if (mViewBehind != null) {
					switch (position) {
					case 0:
	 ...
	 */
	OnPageChangeListener setInternalPageChangeListener(OnPageChangeListener listener) {  // TODO: 2016/12/22 据说可以去掉
...
//			return mQuickReturn;
		...
		return mIsBeingDragged || mQuickReturn;//TODO: 2016/12/22  可修改
	}
...
//			return mQuickReturn;
	...
	protected void dispatchDraw(Canvas canvas) {
        ...
        mViewBehind.drawOffsetFade(mContent,canvas,getPercentOpen());//绘制剩余部分淡入淡出效果
